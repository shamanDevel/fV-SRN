...
bool ImGui::SliderDouble2(const char* label, double v[2], double v_min, double v_max, const char* format, float power)
{
    return SliderScalarN(label, ImGuiDataType_Double, v, 2, &v_min, &v_max, format, power);
}

bool ImGui::SliderDouble3(const char* label, double v[3], double v_min, double v_max, const char* format, float power)
{
    return SliderScalarN(label, ImGuiDataType_Double, v, 3, &v_min, &v_max, format, power);
}

bool ImGui::SliderDouble4(const char* label, double v[4], double v_min, double v_max, const char* format, float power)
{
