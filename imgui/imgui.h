...
namespace ImGui
{
    ...
    IMGUI_API bool          SliderDouble(const char* label,  double* v,   double v_min, double v_max, const char* format = "%.3f", float power = 1.0f);     // adjust format to decorate the value with a prefix or a suffix for in-slider labels or unit display. Use power!=1.0 for power curve sliders
    IMGUI_API bool          SliderDouble2(const char* label, double v[2], double v_min, double v_max, const char* format = "%.3f", float power = 1.0f);
    IMGUI_API bool          SliderDouble3(const char* label, double v[3], double v_min, double v_max, const char* format = "%.3f", float power = 1.0f);
    IMGUI_API bool          SliderDouble4(const char* label, double v[4], double v_min, double v_max, const char* format = "%.3f", float power = 1.0f);
